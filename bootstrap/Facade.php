...
abstract class Facade
{
    ...
    {
        // LaravelOrbStack guard: begin
        // This file is vendor's Facade.php verbatim plus this block; composer.json
        // loads it by classmap and excludes the original. FacadeGuardTest fails
        // when vendor's copy changes: re-copy it and re-insert this block.
        // Frame 0 is the code that wrote `Foo::bar()`; the framework's own facade
        // calls (HasTimestamps -> Date::now(), ...) come from vendor/. The guard
        // is undefined where an entry point skips bootstrap/autoload.php
        // (PHPStan booting Larastan), and there the facade behaves as vendor's.
        if (\function_exists('LaravelOrbStack\reject_app_call')) {
