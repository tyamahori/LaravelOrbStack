FROM golang:1.25.3-bookworm@sha256:51b6b12427dc03451c24f7fc996c43a20e8a8e56f0849dd0db6ff6e9225cc892 AS go
...
FROM go AS runn
RUN go install github.com/k1LoW/runn/cmd/runn@v0.140.0

FROM go AS mysqldef
RUN go install github.com/sqldef/sqldef/cmd/mysqldef@v3.1.17

FROM go AS psqldef
RUN go install github.com/sqldef/sqldef/cmd/psqldef@v3.1.17
