FROM golang:1.25.3-bookworm@sha256:4f43b271f9673eb7bd0cb3a49cc17b08d8d6ee110277e26dbacc93c43a5a7793 AS go
...
FROM go AS runn
RUN go install github.com/k1LoW/runn/cmd/runn@v0.140.3
